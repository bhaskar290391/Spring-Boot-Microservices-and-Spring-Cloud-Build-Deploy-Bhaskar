...
#Git Hub repository for given project 
https://github.com/simplyi/SpringCloudVideoCourse/tree/update-spring-boot-v3.3.2

#GITHUB repository for spring cloud gateway
https://github.com/simplyi/SpringCloudAPIGateway/tree/update-spring-boot-v3.3.2

#GITHUB FOR EURAKA CLUSTER DEMO
https://github.com/simplyi/EurekaServerClusterDemo
